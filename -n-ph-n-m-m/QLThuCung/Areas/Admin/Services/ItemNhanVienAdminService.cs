...
{
    public class ItemNhanVienAdminService : INhanVienAdminService
    {
        private readonly AppDbContext _context;
        private readonly UserManager<NguoiDung> _userManager;

        public ItemNhanVienAdminService(AppDbContext context, UserManager<NguoiDung> userManager)
        {
            _context = context;
        ...
        public async Task<IEnumerable<NguoiDung>> List()
        {
            ...
            var role = await _context.Roles.FirstOrDefaultAsync(r => r.Name == "NhanVien");
