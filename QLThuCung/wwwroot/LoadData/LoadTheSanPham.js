$(document).ready(function () {
    ...
    $('#ListDanhMuc').on('click', 'li', function () {
        ...
        LoadTheSanPham(currentDanhMuc, currentMaxPrice, priceSortOrder, salesFilter, salesSortOrder, ratingFilter, ratingSortOrder, searchQuery);
...
function LoadTheSanPham(dataDanhMuc = 0, maxPrice = null, priceSortOrder = null, salesFilter = "tatCaLuotBan", salesSortOrder = null, ratingFilter = "tatCaSao", ratingSortOrder = null, searchQuery = "") {
    $.ajax({
        url: '/khachhang/sanpham/list',
        type: 'GET',
        dataType: 'json',
        success: function (response) {
            console.log('Filters:', { salesFilter, ratingFilter, searchQuery });
            ...
            if (priceSortOrder === 'asc') {
                ...
                filteredProducts.sort((a, b) => b.gia - b.gia);
